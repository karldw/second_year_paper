...
\begin{figure}[hbt]
    \caption{Estimated sales count anticipation effects}
...
\end{figure}
\begin{figure}[hbt]
     \caption{Estimated total sales anticipation effects are small relative to standard deviation}
...
Calculating the standard deviation on only periods within our event window -- from 70~days before the dividend is sent to 70~days after -- gives slightly larger standard deviations, and therefore even smaller effect sizes.

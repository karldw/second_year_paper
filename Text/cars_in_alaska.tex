...
\begin{tabular}{l S p{0.5\linewidth}}
	...
	\midrule
	%TODO: add counts for unintelligible dates by re-running load_manheim.
	...
	\addlinespace
    % TODO: re-run clean_car_auctions.r and uncomment the snippet lines below.

    Duplicate sales & 3132085 & Same \textsc{vin} sold twice within a year.\\
    % Duplicate sales & \snippet{cleaning_count_resold.tex} & Same \textsc{vin} sold twice within a year.\\
    \addlinespace
	Weird vehicles & 20299 & Trailers, boats, air compressors, golf carts, vehicles with incomplete bodies, ATVs and RVs.\\
    % Weird vehicles & \snippet{cleaning_count_weird_vehicles.tex} & Trailers, boats, air compressors, golf carts, vehicles with incomplete bodies, ATVs and RVs.\\
	\addlinespace
    Bad odometer & 586941 & Auction comments indicate reported miles are inaccurate.\\
    % Bad odometer & \snippet{cleaning_count_bad_odometer.tex} & Auction comments indicate reported miles are inaccurate.\\
	\addlinespace
    Damaged & 2665224 & Auction comments indicate vehicle is substantially damaged. \\
    % Damaged & \snippet{cleaning_count_damaged.tex} & Auction comments indicate vehicle is substantially damaged. \\
	\addlinespace
    Bad price & 59193 & Auction price seems unreasonable, outside the interval $[100, \min\{80000, 1.5\times \textsc{msrp} \}]$.\\
    % Bad price & \snippet{cleaning_count_price.tex} & Auction price seems unreasonable, outside the interval $[100, \min\{80000, 1.5\times \textsc{msrp} \}]$.\\
	\addlinespace
    Canadian & 132118 & Auction comments indicate vehicle is Canadian.\\
    % Canadian & \snippet{cleaning_count_canadian.tex} & Auction comments indicate vehicle is Canadian.\\
    \bottomrule
    \addlinespace
\end{tabular}
\footnotesize

...
\begin{itemize}
    ...
    \item Findings -- small results (preferred results are logs, robustness in levels)
    \begin{itemize}
        \item Sales counts per capita
        \item Sales volumes per capita
        ...
        \end{itemize}
        \item Results are robust to dropping any particular year (make a graph)
    \end{itemize}
...
\begin{figure}[hbt]
    ...
    \includegraphics[width=\linewidth]{anticipation_window_sale_count_weekly_notitle.pdf}
...
\begin{figure}[hbt]
     ...
     \label{fig:anticipation_window_sale_tot}
        \includegraphics[width=\linewidth]{anticipation_window_sale_tot_weekly_notitle.pdf}
